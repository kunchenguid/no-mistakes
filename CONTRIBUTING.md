...
- Do not commit `.no-mistakes/` local state or evidence artifacts; keep render and test verification in the no-mistakes PR body or in dedicated external evidence.

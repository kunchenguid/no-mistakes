...
Template for the subject of commits created by the shared Build, Review, Test, Document, and Lint fix path.
...
| Variable | Value |
| --- | --- |
| `{{.Step}}` | Pipeline step name, such as `build`, `review`, `test`, `document`, or `lint` |

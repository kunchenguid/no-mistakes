...
Exceptional unavailable-head release and stale-owner supersession use the same setting for every remote read, staging fetch, and advertised-ref reachability probe; each operation receives a fresh timeout budget.

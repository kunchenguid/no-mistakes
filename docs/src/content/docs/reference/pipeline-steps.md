...
Pipeline steps do not treat missing, malformed, or semantically incomplete structured analyzer output as a clean result. Such output stops Review, Test, and Lint; Document instead surfaces an `ask-user` finding for human review.

...
- For GitHub, when `providers.github.draft_pull_requests` is enabled, new PRs are created as drafts (`gh pr create --draft`); existing PRs are not toggled between draft and ready

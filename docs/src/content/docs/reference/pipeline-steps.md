...
- Screenshots, images, GIFs, and videos without a repository path or externally visible URL are reported as `ask-user` warnings because the generated PR would otherwise show only a local file path.

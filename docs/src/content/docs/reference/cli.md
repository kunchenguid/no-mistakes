...
Every settlement refusal names `next_action.code: inspect_and_reconcile_manually`, so a refusal is never a dead end even for a shape status advertised in error.

...
On very long runs, the PR body keeps the most recent pipeline update rounds and replaces older rounds with an omission marker before it reaches GitHub's 65536-character body limit.

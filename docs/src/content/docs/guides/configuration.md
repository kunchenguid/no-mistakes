...
Bitbucket Cloud authenticates through the `twg` CLI rather than config files; see [Provider Integration](/no-mistakes/guides/provider-integration/#bitbucket-cloud).

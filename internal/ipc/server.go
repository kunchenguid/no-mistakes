...
func readOnlyMethod(method string) bool {
	switch method {
	case MethodHealth, MethodGetRun, MethodGetStepDiff, MethodGetRuns, MethodGetRunsForHead, MethodGetActiveRun, MethodGateContext, MethodAdmitPush, MethodAdmitPushBatch:
		return true
	default:
		return false
	}

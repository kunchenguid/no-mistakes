...
var migrationStatements = []string{
	...
	`ALTER TABLE runs ADD COLUMN intent_leading_structure_preserved INTEGER NOT NULL DEFAULT 0`,
	`ALTER TABLE runs ADD COLUMN intent_axi_run INTEGER NOT NULL DEFAULT 0`,

...
func TestOpenMigratesRunSyncProvenanceWithoutBackfillingMutableHead(t *testing.T) {
	...
	if run.TargetBranch != "" || run.TargetSHA != "" {
		t.Fatalf("legacy run gained an inferred target identity: %#v", run)
	}

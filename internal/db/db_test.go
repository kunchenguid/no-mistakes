...
func TestOpenMigratesRunSyncProvenanceWithoutBackfillingMutableHead(t *testing.T) {
	...
	if run.SubmittedHeadSHA != nil || run.NoMistakesVersion != nil || run.NoMistakesBuildSHA != nil || run.ReviewApprovedHeadSHA != nil || run.CertifiedHeadSHA != nil || run.ReviewFleetFingerprint != nil || run.LastPushedSHA != nil || run.PushGeneration != nil || run.PushTargetFingerprint != nil {
	...
	if run.ReviewFleetEnabled {
		t.Fatalf("legacy run was upgraded into fleet mode: %#v", run)
	}
}

...
func TestOpenCreatesSchema(t *testing.T) {
	...
	for _, column := range []string{"last_activity_at", "last_activity", "agent_pid", "ci_fix_attempts", "ci_pending_publish_head", "ci_pending_publish_attempts"} {
...
func TestOpenMigratesStepActivityColumns(t *testing.T) {
	...
	for _, column := range []string{"last_activity_at", "last_activity", "agent_pid", "ci_pending_publish_head", "ci_pending_publish_attempts"} {
		if !hasColumn(t, d, "step_results", column) {

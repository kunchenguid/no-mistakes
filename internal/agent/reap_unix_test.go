...
// TestCodexAgent_Run_CancellationTerminatesProcessGroup proves the absolute
// invocation wall-clock limit retains the native command's existing process-
// group cleanup. A tool child must not survive cancellation of its agent.

...
- The user intent's stated constraints bind your fixes exactly as they bind the original change: never introduce new dependencies, tools, parsers, or machinery a constraint rules out. When the smallest honest fix would need them, leave the finding unresolved and say so in the summary instead of exceeding the constraint.

...
%s`,
	...
	historySection := executionContextPromptSection() + fixRoundProvenanceClause(sctx) + intentConformanceReviewClause(sctx) + pipelineDeliveryPhaseClause() + testguidance.Rule + testguidance.ReviewerAction
	if !reviewFleetEnabled(sctx) {
